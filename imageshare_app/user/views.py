...
from .forms import UserRegisterForm, UserUpdateForm, ImageUploadForm # Import the form we just created
...
def imageupload(request):
    if request.method == 'POST':
        ...
        if i_form.is_valid():
            ...
            i_form.save()
            messages.add_message(request, messages.SUCCESS, f'Your image has been uploaded!')
            return redirect('profile')
    else:
